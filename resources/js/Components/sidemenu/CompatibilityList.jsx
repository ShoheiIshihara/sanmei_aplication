...
import { getAppraisedParsonListFromApi} from "../../store/modules/AppraisedParson";
import { getCompatibilityResultFromApi} from "../../store/modules/Calculation";
...
export default function AppraisedParsonList(props){
    ...
    <button className='w-full rounded shadow-md my-6 py-2 text-white bg-ebb-700 hover:bg-ebb-500 hover:shadow-none' onClick={kantei}>鑑定</button>
     </>
    )
}
