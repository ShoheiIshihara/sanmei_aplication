...
export default function FirstPasonResult(){
    ...
    return(
       <div className='mx-auto w-full md:h-[360px]'>
            ...
            <div>
                <div className="card  shadow-md  bg-white w-full h-full ">
                    <div className="card-body  mx-auto">
                        <h2 className='card-title mx-auto'>
                            ...
                            {resultCompatibility.first_parson.profile.birth_year}年
                            {resultCompatibility.first_parson.profile.birth_month}月
                            {resultCompatibility.first_parson.profile.birth_day}日
                            ...
                            <div className='w-full'>
                                <table  className='text-2xl'>
                                    <tbody>
                                        ...
                                        <tr className="">
                                            <ResultTableTd value={resultCompatibility.first_parson.sanmei.kanshi_detail.nikkanshi_detail.tenchusatsu_detail[0].tenchusatsu.substr(0,1) }  tablestyle="w-[50px]"/>
                                            <ResultTableTd />
                                ...
                                <div className='flex justify-center w-full gap-2 mb-2'>
                                    <button className="btn btn-secondary hover:shadow-2xl hover:scale-105 transition ease-in-out duration-700 " onClick={()=>window.first_parson_nikkanshi_modal.showModal()}>日干支</button>
                                    <button className="btn btn-secondary hover:shadow-2xl hover:scale-105 transition ease-in-out duration-700 " onClick={()=>window.first_parson_gekkanshi_modal.showModal()}>月干支</button>
                                    <button className="btn btn-secondary hover:shadow-2xl hover:scale-105 transition ease-in-out duration-700 " onClick={()=>window.first_parson_nenkanshi_modal.showModal()}>年干支</button>
                                </div>
                            </div>
                            {/* 陽占 */}
                ...
                {/* モーダル内容 */}
                <ModalLayout title='日干支解説' idName='first_parson_nikkanshi_modal'>
                <hr  className=" border-yellow-300 mb-4"/>    

                <div className='text-2xl font-semibold text-center md:text-left'>
                    <p>
                        <span className='mx-4'>干支：{resultCompatibility.first_parson.sanmei.kanshi_detail.nikkanshi_detail.kanshi_detail.kanshi}</span>
                        <span className='md:inline block '>～{resultCompatibility.first_parson.sanmei.kanshi_detail.nikkanshi_detail.kanshi_detail.nickname}～</span>
                    </p>
                    
                </div>
                <p className='text-lg mt-[20px] indent-4 leading-loose tracking-normal md:ml-6'>
                    {resultCompatibility.first_parson.sanmei.kanshi_detail.nikkanshi_detail.kanshi_detail.kanshi_detail}
                </p>
                <p className='text-lg mt-[20px] indent-4 mb-6 leading-loose tracking-normal md:ml-6'>
                    {resultCompatibility.first_parson.sanmei.kanshi_detail.nikkanshi_detail.kanshi_detail.explanation}
                </p>

                {resultCompatibility.first_parson.sanmei.kanshi_detail.nikkanshi_detail.gou_detail[0].gou_id !=0 ?
                    (<dl className="mx-3 my-3 p-2 bg-gray-100  rounded">
                        <dt>●{resultCompatibility.first_parson.sanmei.kanshi_detail.nikkanshi_detail.gou_detail[0].gou}</dt>
                        <dd className="ml-2 mt-1">{resultCompatibility.first_parson.sanmei.kanshi_detail.nikkanshi_detail.gou_detail[0].gou_detail}</dd>
                    </dl>)
                :""}
                {resultCompatibility.first_parson.sanmei.kanshi_detail.nikkanshi_detail.ijou_detail[0].ijou_kanshi_id !=0 ?
                    (<dl className="mx-3 my-3 p-2 bg-gray-100 rounded">
                        <dt>{resultCompatibility.first_parson.sanmei.kanshi_detail.nikkanshi_detail.ijou_detail[0].ijou_kanshi}</dt>
                        <dd className="ml-2 mt-1">{resultCompatibility.first_parson.sanmei.kanshi_detail.nikkanshi_detail.ijou_detail[0].ijou_detail}</dd>
                    </dl>)
                :""}
                </ModalLayout>

                <ModalLayout title='月干支解説' idName='first_parson_gekkanshi_modal'>
                <hr  className=" border-yellow-300 mb-4"/>    

                    <div className='text-2xl font-semibold text-center md:text-left'>
                        <p>
                            <span className='mx-4'>干支：{resultCompatibility.first_parson.sanmei.kanshi_detail.gekkanshi_detail.kanshi_detail.kanshi}</span>
                            <span className='md:inline block '>～{resultCompatibility.first_parson.sanmei.kanshi_detail.gekkanshi_detail.kanshi_detail.nickname}～</span>
                        </p>
                        
                    </div>
                    <p className='text-lg mt-[20px] indent-4 leading-loose tracking-normal md:ml-6'>
                        {resultCompatibility.first_parson.sanmei.kanshi_detail.gekkanshi_detail.kanshi_detail.kanshi_detail}
                    </p>
                    <p className='text-lg mt-[20px] indent-4 mb-6 leading-loose tracking-normal md:ml-6'>
                        {resultCompatibility.first_parson.sanmei.kanshi_detail.gekkanshi_detail.kanshi_detail.explanation}
                    </p>

                    {resultCompatibility.first_parson.sanmei.kanshi_detail.gekkanshi_detail.gou_detail[0].gou_id !=0 ?
                        (<dl className="mx-3 my-3 p-2 bg-gray-100  rounded">
                            <dt>●{resultCompatibility.first_parson.sanmei.kanshi_detail.gekkanshi_detail.gou_detail[0].gou}</dt>
                            <dd className="ml-2 mt-1">{resultCompatibility.first_parson.sanmei.kanshi_detail.gekkanshi_detail.gou_detail[0].gou_detail}</dd>
                        </dl>)
                    :""}
                    {resultCompatibility.first_parson.sanmei.kanshi_detail.gekkanshi_detail.ijou_detail[0].ijou_kanshi_id !=0 ?
                        (<dl className="mx-3 my-3 p-2 bg-gray-100 rounded">
                            <dt>{resultCompatibility.first_parson.sanmei.kanshi_detail.gekkanshi_detail.ijou_detail[0].ijou_kanshi}</dt>
                            <dd className="ml-2 mt-1">{resultCompatibility.first_parson.sanmei.kanshi_detail.gekkanshi_detail.ijou_detail[0].ijou_detail}</dd>
                        </dl>)
                    :""}
                </ModalLayout>

                <ModalLayout title='年干支解説' idName='first_parson_nenkanshi_modal'>
                    <hr  className=" border-yellow-300 mb-4"/>    

                    <div className='text-2xl font-semibold text-center md:text-left'>
                        <p>
                            <span className='mx-4'>干支：{resultCompatibility.first_parson.sanmei.kanshi_detail.nenkanshi_detail.kanshi_detail.kanshi}</span>
                            <span className='md:inline block '>～{resultCompatibility.first_parson.sanmei.kanshi_detail.nenkanshi_detail.kanshi_detail.nickname}～</span>
                        </p>
                        
                    </div>
                    <p className='text-lg mt-[20px] indent-4 leading-loose tracking-normal md:ml-6'>
                        {resultCompatibility.first_parson.sanmei.kanshi_detail.nenkanshi_detail.kanshi_detail.kanshi_detail}
                    </p>
                    <p className='text-lg mt-[20px] indent-4 mb-6 leading-loose tracking-normal md:ml-6'>
                        {resultCompatibility.first_parson.sanmei.kanshi_detail.nenkanshi_detail.kanshi_detail.explanation}
                    </p>

                    {resultCompatibility.first_parson.sanmei.kanshi_detail.nenkanshi_detail.gou_detail[0].gou_id !=0 ?
                        (<dl className="mx-3 my-3 p-2 bg-gray-100  rounded">
                            <dt>●{resultCompatibility.first_parson.sanmei.kanshi_detail.nenkanshi_detail.gou_detail[0].gou}</dt>
                            <dd className="ml-2 mt-1">{resultCompatibility.first_parson.sanmei.kanshi_detail.nenkanshi_detail.gou_detail[0].gou_detail}</dd>
                        </dl>)
                    :""}
                    {resultCompatibility.first_parson.sanmei.kanshi_detail.nenkanshi_detail.ijou_detail[0].ijou_kanshi_id !=0 ?
                        (<dl className="mx-3 my-3 p-2 bg-gray-100 rounded">
                            <dt>{resultCompatibility.first_parson.sanmei.kanshi_detail.nenkanshi_detail.ijou_detail[0].ijou_kanshi}</dt>
                            <dd className="ml-2 mt-1">{resultCompatibility.first_parson.sanmei.kanshi_detail.nenkanshi_detail.ijou_detail[0].ijou_detail}</dd>
                        </dl>)
                    :""}
                </ModalLayout>
            </div>
